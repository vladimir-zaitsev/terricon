...
- Для обучения, особенно первого изучаемого языка, важен "порог входа" -- сколько всего нужно узнать, прежде чем сможешь написать свой первую "настоящую" программу (нетривиальную, не "Hello world"). Имеется в виду "вход в программирование" -- минимальная подготовка для самостоятельного движения дальше. 
...
#### Явное или скрытое
Тут в первую очередь приходят на ум значимые отступы на Python. Также можно привести в пример явное обозначение первой верки условного оператора на Pascal.
...
И Именно он будет неожиданной и свежей идеей для этой статьи, это Kotlin (или Котлин, это вообще-то что русское слово, это название острова, на котором находится город Кронштадт).
...
Что же до популярности, областей применения, сообщества, библиотек и инструментов, всё это примерно как Java (ближайшего родственника кстати), только ещё и продолжает расти.
...
По сравнивать пару основных кандитатов примерно по этому плану, и даже предложить свежее "Соломоново решение".
